    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <header className="border-b-2 border-zinc-900 pb-4 mb-8 text-center">
        <div className="flex justify-between items-end mb-2 text-xs font-bold uppercase tracking-widest border-b border-zinc-200 pb-2">
          ...
          <span className="text-xl font-serif lowercase italic tracking-tight text-black">Digital Citizen</span>
          <span className="text-black">{new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</span>
        </div>
        <h1 className="font-playfair text-7xl md:text-9xl font-black tracking-tighter uppercase leading-none mt-4 text-black">
          The Gazette
        </h1>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-8">
          {mainStory ? (
            <article className="group cursor-pointer">
              <div className="border-b border-zinc-200 pb-6 mb-6 text-black">
        ...
        <div className="lg:col-span-4 space-y-8 border-l border-zinc-200 pl-8">
          <h3 className="font-bold uppercase tracking-widest text-sm border-b-4 border-zinc-900 pb-1 mb-4 text-black">Latest</h3>
          {otherStories.map((story: Post) => (
            <article key={story.id} className="border-b border-zinc-100 pb-4 last:border-0 text-black">
