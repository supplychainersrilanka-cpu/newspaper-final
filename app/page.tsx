            ...
            <article className="group cursor-pointer">
              <div className="border-b border-zinc-200 pb-6 mb-6">
                ...
                <p className="mt-4 text-zinc-600 text-lg leading-relaxed">
                  {mainStory.content?.substring(0, 250)}...
                </p>
              </div>
            </article>
          ) : (
            <p className="font-serif italic text-zinc-400 text-center py-20 border-2 border-dashed">The presses are waiting. Publish your first story at /admin.</p>
          )}
        </div>
